...
export const isGreeting=(text:string)=>/^(السلام عليكم|وعليكم السلام|مرحبا|مرحبا بك|اهلا|اهلين|هلا|hello|hi|hey|good morning|good evening|شكرا|thanks|thank you)$/i.test(normalizeText(text))
