...
const labels: Record<string, { ar: string; en: string }> = {
  ...
  conversation_not_active: { ar: 'المحادثة مغلقة أو مؤرشفة. أعد فتحها أولًا.', en: 'The conversation is closed or archived. Reopen it first.' },
  handoff_not_waiting: { ar: 'طلب التحويل لم يعد بانتظار الاستلام.', en: 'This handoff is no longer waiting to be claimed.' },
  handoff_not_active: { ar: 'طلب التحويل لم يعد نشطًا.', en: 'This handoff is no longer active.' },
  invalid_handoff_reason: { ar: 'سبب التحويل غير صالح.', en: 'The handoff reason is invalid.' },
